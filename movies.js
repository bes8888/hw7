firebase.auth().onAuthStateChanged(async function(user) {
  ...
  if (user) {
    // Signed in
          // Add the current user to the database if not already there
      ...
      // This code displays the movie list
      
      let apiKey = '197b175c911c90148de2f4232f3d8095'
      ...
      // not logged in, so display firebaseUI to get logged in
